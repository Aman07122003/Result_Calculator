...
export default function Result() {
  ...
  const [compareRollNumber, setCompareRollNumber] = useState(""); // State for comparison input
  ...
  const handleCompare = () => {
    ...
    navigate(`/compare/${rollNumber}/${compareRollNumber}`);
  };
    ...
    <div className="md:min-h-screen h-[1200px] w-full bg-gray-200 flex items-center justify-center ">
        <div className="min-h-[calc(100vh+20px)] flex items-center justify-center w-[95%] md:w-[55%] bg-white pb-8 pt-8 rounded-2xl shadow-2xl">
            <div className="h-[97%] w-[91%]" >
                ...
                <div className="flex md:text-[25px] md:mt-7 mt-4 font-semibold w-full items-center h-[5%] md:h-[8%]">Personal Information</div>
                ...
                <div className="md:h-[100px] md:mt-1 md:flex items-center justify-between w-full h-[150px] mt-3 md:flex-row flex-col gap-y-2 md:gap-y-0">
                    <div className="md:h-[70%] h-[25%] md:w-[30%] bg-[#e2f0fd] items-center flex justify-center rounded-2xl">
                        <div className="md:h-[90%] h-[80%] w-[80%] md:flex-col flex  gap-x-1">
                            <div className="md:h-[50%] md:w-full md:text-xl text-sm font-bold flex items-center text-blue-800">Name </div>
                            <div className="md:h-[40%] md:w-full flex items-center text-sm md:text-lg font-sans text-blue-800"> {studentData.name}</div>
                        </div>
                    </div>
                    <div className="md:h-[70%] md:w-[30%] h-[25%] md:mt-0 mt-2 bg-[#11f01134] items-center flex justify-center rounded-2xl">
                        <div className="md:h-[90%] w-[80%] flex md:flex-col items-center gap-x-1 md:gap-0">
                            <div className="md:h-[50%] md:w-full md:text-xl text-sm font-bold flex items-center text-green-800">Roll Number</div>
                            <div className="h-[40%] md:w-full text-sm md:text-lg font-sans text-green-800"> {rollNumber}</div>
                        </div>
                    </div>
                    <div className="md:h-[70%] md:w-[30%] h-[25%] mt-2 bg-[#ffff0060] items-center flex justify-center rounded-2xl">
                        <div className="md:h-[90%] w-[80%] flex md:flex-col items-center gap-x-1 md:gap-0">
                            <div className="md:h-[50%] md:w-full md:text-xl text-sm font-bold flex items-center text-amber-800">Semester</div>
                            <div className="h-[40%] md:w-full text-sm md:text-lg font-sans text-amber-800"> {studentData.semester}</div>
                        </div>
                    </div>
                </div>
                <div className="w-full md:h-[55%]">
                  <div className="h-[30px] md:h-[8%] md:mt-2.5 md:text-[25px] font-semibold"> Detailed Subject Grades</div>
                ...
                <div className="h-[150px] md:h-[150px] w-full md:mt-5 mt-5 ">
                    <div className="md:text-[25px] md:h-[40%] flex items-center font-semibold">Result Summary</div>
                ...
                <div className="h-[15%] mt-2 w-full">
                  <div className="md:text-[25px] md:h-[40%] flex items-center font-semibold">Compare Your Result</div>
